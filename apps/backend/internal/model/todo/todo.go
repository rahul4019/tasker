...
// * All the fields which can be NULL(nullable) are of type pointer because it zero value of reference type is nill
type Todo struct {
	model.Base
	...
	CommpletedAt *time.Time `json:"commpletedAt" db:"commpleted_at"`
