...
import (
	...
	loggerConfig "github.com/rahul4019/tasker/internal/logger"
...
// multitracer allows chaining of multiple tracers
...
func (mt *multiTracer) TraceQueryStart(ctx context.Context, conn *pgx.Conn, data pgx.TraceQueryStartData) context.Context {
	for _, tracer := range mt.tracers {
		//* this checks "does this tracer implement TraceQueryStart"
